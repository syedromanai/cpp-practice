...
The two conversion functions are named the wrong way round: `c_to_f` takes a
Fahrenheit value and returns Celsius, and `f_to_c` does the reverse. The output
is correct because `main` calls them accordingly, but the names should be
swapped.
